...
GLOBAL_SECONDARY_0_SIGNALNAME = HelloWorld_inst/cpu0_inst_system_resetn_o_net;
GLOBAL_SECONDARY_0_DRIVERTYPE = SLICE;
GLOBAL_SECONDARY_0_LOADNUM = 345;
...
GLOBAL_SECONDARY_2_SIGNALNAME = HelloWorld_inst/sysmem0_inst/lscc_sys_mem_inst/N_222_i;
...
GLOBAL_SECONDARY_3_LOADNUM = 133;
GLOBAL_SECONDARY_3_SIGTYPE = RST;
; Global secondary clock #4
GLOBAL_SECONDARY_4_SIGNALNAME = HelloWorld_inst/cpu0_inst/riscvsmall_inst/genblk11.i_Riscv_Dbg_IC/execute_arbitration_isStuck_i;
GLOBAL_SECONDARY_4_DRIVERTYPE = SLICE;
GLOBAL_SECONDARY_4_LOADNUM = 106;
